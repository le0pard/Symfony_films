...
<div class="digg_pagination">
	...
	<?php else: ?>
		<a class="prev_page" href="<?php echo url_for('@film_types_all') ?>?page=<?php echo $pager->getPreviousPage() ?>">&laquo; Сюда</a>
	<?php endif ?>
    ...
    <?php foreach ($pager->getLinks(15) as $page): ?>
      ...
      <?php else: ?>
        <a href="<?php echo url_for('@film_types_all') ?>?page=<?php echo $page ?>"><?php echo $page ?></a>
      <?php endif; ?>
    <?php endforeach; ?>
	...
	<?php else: ?>
    	<a class="next_page" href="<?php echo url_for('@film_types_all') ?>?page=<?php echo $pager->getNextPage() ?>">Туда &raquo;</a>
	<?php endif ?>
