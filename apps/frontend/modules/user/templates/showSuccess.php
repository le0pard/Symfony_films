...
<div>
<img src="http://<?php echo sfConfig::get('app_integration_jabber_server'); ?>/plugins/presence/status?jid=<?php echo $user_data->getLogin() ?>@<?php echo sfConfig::get('app_integration_jabber_domain'); ?>" title="jabber status" />
