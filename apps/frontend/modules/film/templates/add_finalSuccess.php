...
<form id="film_form_final" action="<?php echo url_for('film_add_final', $film) ?>" method="POST">
	<h2><input class="css_button" style="float:right; margin-top:0!important" name="pub" type="submit" value="Опубликовать" />
...
<form id="film_form_final" action="<?php echo url_for('film_twitter', $film) ?>" method="POST">
	<input class="css_button" type="submit" name="pub" value="Twitter!" />
</form>
<?php endif ?>
