...
abstract class BaseAfishaZalTimeForm extends BaseFormPropel
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'afisha_zal_date_id' => new sfWidgetFormPropelChoice(array('model' => 'AfishaZalDate', 'add_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'afisha_zal_date_id' => new sfValidatorPropelChoice(array('model' => 'AfishaZalDate', 'column' => 'id')),
