...
class UsersTableMap extends TableMap {
    ...
    $this->addRelation('Film', 'Film', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
    ...
    $this->addRelation('News', 'News', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
    $this->addRelation('Afisha', 'Afisha', RelationMap::ONE_TO_MANY, array('id' => 'user_id', ), null, null);
	} // buildRelations()
