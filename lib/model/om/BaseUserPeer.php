...
abstract class BaseUserPeer {
	...
	const WEBSITE_BLOG = 'user.WEBSITE_BLOG';
	...
	const PERSISTENCE_TOKEN = 'user.PERSISTENCE_TOKEN';
	...
	const COUNT_OF_FILMS = 'user.COUNT_OF_FILMS';
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::WEBSITE_BLOG);
		...
		$criteria->addSelectColumn(UserPeer::PERSISTENCE_TOKEN);
		$criteria->addSelectColumn(UserPeer::IS_SUPER_ADMIN);
		$criteria->addSelectColumn(UserPeer::COUNT_OF_FILMS);
