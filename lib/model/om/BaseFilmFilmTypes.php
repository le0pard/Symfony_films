...
abstract class BaseFilmFilmTypes extends BaseObject  implements Persistent {
  ...
  const PEER = 'FilmFilmTypesPeer';
	...
	/**
	 * Initializes internal state of BaseFilmFilmTypes object.
	 * @see        applyDefaults()
	 */
	...
	public function getFilmTypes(PropelPDO $con = null)
	{
		if ($this->aFilmTypes === null && ($this->film_genre_id !== null)) {
			$c = new Criteria(FilmTypesPeer::DATABASE_NAME);
			$c->add(FilmTypesPeer::ID, $this->film_genre_id);
			$this->aFilmTypes = FilmTypesPeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
