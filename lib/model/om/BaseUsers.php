...
abstract class BaseUsers extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->persistence_token = ($row[$startcol + 10] !== null) ? (string) $row[$startcol + 10] : null;
			$this->is_super_admin = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
			$this->count_of_films = ($row[$startcol + 12] !== null) ? (int) $row[$startcol + 12] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[10] => $this->getPersistenceToken(),
			$keys[11] => $this->getIsSuperAdmin(),
			$keys[12] => $this->getCountOfFilms(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[10], $arr)) $this->setPersistenceToken($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setIsSuperAdmin($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setCountOfFilms($arr[$keys[12]]);
