...
abstract class BaseUsers extends BaseObject  implements Persistent {
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->persistence_token = ($row[$startcol + 9] !== null) ? (string) $row[$startcol + 9] : null;
			$this->is_super_admin = ($row[$startcol + 10] !== null) ? (boolean) $row[$startcol + 10] : null;
			$this->count_of_films = ($row[$startcol + 11] !== null) ? (int) $row[$startcol + 11] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[9] => $this->getPersistenceToken(),
			$keys[10] => $this->getIsSuperAdmin(),
			$keys[11] => $this->getCountOfFilms(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[9], $arr)) $this->setPersistenceToken($arr[$keys[9]]);
		if (array_key_exists($keys[10], $arr)) $this->setIsSuperAdmin($arr[$keys[10]]);
		if (array_key_exists($keys[11], $arr)) $this->setCountOfFilms($arr[$keys[11]]);
