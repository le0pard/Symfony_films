...
abstract class BaseNews extends BaseObject  implements Persistent {
	...
	public function setIsVisible($v)
	{
		...
		if ($this->is_visible !== $v || $this->isNew()) {
			$this->is_visible = $v;
			$this->modifiedColumns[] = NewsPeer::IS_VISIBLE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->is_visible = ($row[$startcol + 4] !== null) ? (boolean) $row[$startcol + 4] : null;
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(NewsPeer::IS_VISIBLE)) $criteria->add(NewsPeer::IS_VISIBLE, $this->is_visible);
