...
abstract class BaseFilmTotalRatingPeer {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
		...
		} elseif ($values instanceof FilmTotalRating) { // it's a model object
			...
			$criteria->add(FilmTotalRatingPeer::ID, (array) $values, Criteria::IN);
			// invalidate the cache for this object(s)
			foreach ((array) $values as $singleval) {
				FilmTotalRatingPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = FilmTotalRatingPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
		...
		$criteria->add(FilmTotalRatingPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(FilmTotalRatingPeer::DATABASE_NAME);
			$criteria->add(FilmTotalRatingPeer::ID, $pks, Criteria::IN);
			$objs = FilmTotalRatingPeer::doSelect($criteria, $con);
		}
		return $objs;
	}
