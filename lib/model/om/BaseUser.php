...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	public function setPasswordSalt($v)
	{
		...
		if ($this->password_salt !== $v) {
			...
			$this->modifiedColumns[] = UserPeer::PASSWORD_SALT;
		}
	...
	public function setWebsiteBlog($v)
	{
		...
		if ($this->website_blog !== $v) {
			$this->website_blog = $v;
			$this->modifiedColumns[] = UserPeer::WEBSITE_BLOG;
		}
	...
	public function setPersistenceToken($v)
	{
		...
		if ($this->persistence_token !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = UserPeer::PERSISTENCE_TOKEN;
		}
	...
	public function setIsSuperAdmin($v)
	{
		...
		if ($this->is_super_admin !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = UserPeer::IS_SUPER_ADMIN;
		}
	...
	public function setCountOfFilms($v)
	{
		...
		if ($this->count_of_films !== $v || $this->isNew()) {
			...
			$this->modifiedColumns[] = UserPeer::COUNT_OF_FILMS;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::WEBSITE_BLOG)) $criteria->add(UserPeer::WEBSITE_BLOG, $this->website_blog);
		...
		if ($this->isColumnModified(UserPeer::PERSISTENCE_TOKEN)) $criteria->add(UserPeer::PERSISTENCE_TOKEN, $this->persistence_token);
		if ($this->isColumnModified(UserPeer::IS_SUPER_ADMIN)) $criteria->add(UserPeer::IS_SUPER_ADMIN, $this->is_super_admin);
		if ($this->isColumnModified(UserPeer::COUNT_OF_FILMS)) $criteria->add(UserPeer::COUNT_OF_FILMS, $this->count_of_films);
	 ...
	 * related UsersUsersGroups from storage. If this User is new, it will return
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related UsersRememberKeys from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related FilmsRelatedByUserId from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related FilmsRelatedByModifiedUserId from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	...
	public function addFilmRelatedByModifiedUserId(Film $l)
	{
		...
		if (!in_array($l, $this->collFilmsRelatedByModifiedUserId, true)) { // only add it if the **same** object is not already associated
			...
			$l->setUserRelatedByModifiedUserId($this);
		}
	}
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related FilmRaitings from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related MessagessRelatedByFromUserId from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related MessagessRelatedByToUserId from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	...
	public function addMessagesRelatedByToUserId(Messages $l)
	{
		...
		if (!in_array($l, $this->collMessagessRelatedByToUserId, true)) { // only add it if the **same** object is not already associated
			...
			$l->setUserRelatedByToUserId($this);
		}
	}
	...
	public function setUserFriendsRelatedByUserId(UserFriends $v)
	{
		...
		if ($v->getUserRelatedByUserId() === null) {
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this User has previously been saved, it will retrieve
	 * related UserFriendssRelatedByFriendId from storage. If this User is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	...
	public function addUserFriendsRelatedByFriendId(UserFriends $l)
	{
		...
		if (!in_array($l, $this->collUserFriendssRelatedByFriendId, true)) { // only add it if the **same** object is not already associated
			...
			$l->setUserRelatedByFriendId($this);
		}
	}
