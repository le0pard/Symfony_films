  ...
  const PEER = 'MessagesPeer';
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->message_type = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			...
			return $startcol + 6; // 6 = MessagesPeer::NUM_COLUMNS - MessagesPeer::NUM_LAZY_LOAD_COLUMNS).
    ...
    if ($this->isNew() && !$this->isColumnModified(MessagesPeer::CREATED_AT))
    {
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setMessageType($arr[$keys[2]]);
