...
abstract class BaseMessages extends BaseObject  implements Persistent {
	 ...
	 * @var        Users
	 */
	protected $aUsersRelatedByFromUserId;

	/**
	 * @var        Users
	 */
	protected $aUsersRelatedByToUserId;
	...
	public function setFromUserId($v)
	{
		...
		if ($this->aUsersRelatedByFromUserId !== null && $this->aUsersRelatedByFromUserId->getId() !== $v) {
			$this->aUsersRelatedByFromUserId = null;
		}
	...
	public function setToUserId($v)
	{
		...
		if ($this->aUsersRelatedByToUserId !== null && $this->aUsersRelatedByToUserId->getId() !== $v) {
			$this->aUsersRelatedByToUserId = null;
		}
	...
	public function setMessageType($v)
	{
		...
		if ($this->message_type !== $v) {
			$this->message_type = $v;
			$this->modifiedColumns[] = MessagesPeer::MESSAGE_TYPE;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = MessagesPeer::DESCRIPTION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->from_user_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
			$this->to_user_id = ($row[$startcol + 2] !== null) ? (int) $row[$startcol + 2] : null;
			$this->message_type = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			return $startcol + 7; // 7 = MessagesPeer::NUM_COLUMNS - MessagesPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->aUsersRelatedByFromUserId !== null && $this->from_user_id !== $this->aUsersRelatedByFromUserId->getId()) {
			$this->aUsersRelatedByFromUserId = null;
		}
		if ($this->aUsersRelatedByToUserId !== null && $this->to_user_id !== $this->aUsersRelatedByToUserId->getId()) {
			$this->aUsersRelatedByToUserId = null;
		}
	} // ensureConsistency
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->aUsersRelatedByFromUserId !== null) {
				if ($this->aUsersRelatedByFromUserId->isModified() || $this->aUsersRelatedByFromUserId->isNew()) {
					$affectedRows += $this->aUsersRelatedByFromUserId->save($con);
				}
				$this->setUsersRelatedByFromUserId($this->aUsersRelatedByFromUserId);
			}

			if ($this->aUsersRelatedByToUserId !== null) {
				if ($this->aUsersRelatedByToUserId->isModified() || $this->aUsersRelatedByToUserId->isNew()) {
					$affectedRows += $this->aUsersRelatedByToUserId->save($con);
				}
				$this->setUsersRelatedByToUserId($this->aUsersRelatedByToUserId);
			}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if ($this->aUsersRelatedByFromUserId !== null) {
				if (!$this->aUsersRelatedByFromUserId->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsersRelatedByFromUserId->getValidationFailures());
				}
			}

			if ($this->aUsersRelatedByToUserId !== null) {
				if (!$this->aUsersRelatedByToUserId->validate($columns)) {
					$failureMap = array_merge($failureMap, $this->aUsersRelatedByToUserId->getValidationFailures());
				}
			}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(MessagesPeer::MESSAGE_TYPE)) $criteria->add(MessagesPeer::MESSAGE_TYPE, $this->message_type);
		if ($this->isColumnModified(MessagesPeer::DESCRIPTION)) $criteria->add(MessagesPeer::DESCRIPTION, $this->description);
	 ...
	 * @throws     PropelException
	 */
	public function setUsersRelatedByFromUserId(Users $v = null)
	{
		if ($v === null) {
	 ...
	 * @throws     PropelException
	 */
	public function getUsersRelatedByFromUserId(PropelPDO $con = null)
	{
		if ($this->aUsersRelatedByFromUserId === null && ($this->from_user_id !== null)) {
			$this->aUsersRelatedByFromUserId = UsersPeer::retrieveByPk($this->from_user_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsersRelatedByFromUserId->addMessagessRelatedByFromUserId($this);
			 */
		}
		return $this->aUsersRelatedByFromUserId;
	}
	 ...
	 * @throws     PropelException
	 */
	public function setUsersRelatedByToUserId(Users $v = null)
	{
		if ($v === null) {
		...
		$this->aUsersRelatedByToUserId = $v;

		// Add binding for other direction of this n:n relationship.
		// If this object has already been added to the Users object, it will not be re-added.
		if ($v !== null) {
			$v->addMessagesRelatedByToUserId($this);
		}
	 ...
	 * @throws     PropelException
	 */
	public function getUsersRelatedByToUserId(PropelPDO $con = null)
	{
		if ($this->aUsersRelatedByToUserId === null && ($this->to_user_id !== null)) {
			$this->aUsersRelatedByToUserId = UsersPeer::retrieveByPk($this->to_user_id);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->aUsersRelatedByToUserId->addMessagessRelatedByToUserId($this);
			 */
		}
		return $this->aUsersRelatedByToUserId;
	}
